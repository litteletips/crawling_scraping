...
# 読み込みにかかる時間によっては、続きのコンテンツを読めなかったり、無駄にまったりする可能性がある。
# n番目のコンテンツに対応する要素が表示されるまで待つ。nht-of-type()の番号は1始まり。
# タイムアウトは10秒で、10秒待っても表示されない場合は例外を発生させる。

# 実行方法
# python get_more_note_contents_with_explicit_wait.py
