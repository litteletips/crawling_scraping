# TwitterのStreamingAPIで取得したものをBigQueryにインポートする為のスクリプト。
# 5000件をロードして終了する。所要時間はツイートの状況に酔って変わるが、2分程度

# Google BigQueryで以下のように実行すると結果が見える
...
# 実行方法
# forego run python insert_tweets_into_bigquery.py
